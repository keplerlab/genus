...
function Exporter(context) {
  ...
  this.file_obj = new _fileSystem__WEBPACK_IMPORTED_MODULE_1__["default"](context);
  /**
  ...
  function preprocessingTextLayer(layer, tabs) {
    ...
    var weights = [100, 100, 100, 200, 300, 400, 500, 500, 600, 700, 800, 900, 900, 900, 900, 900];
    var text_span_array = [];
  ...
  function getBorderString(border) {
    var borderCssString = ""; //  border: border-width border-style border-color|initial|inherit;
...
function exportFullHTML(context) {
  ...
  try {
    ...
    exporter.setOptions(options); // Use the filesystem class to generate directory path
...
function () {
  ...
  _createClass(utils, [{
    ...
    value: function appKitWeightToCSSWeight(weight) {
